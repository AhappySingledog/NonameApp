    ...
    class Cysx extends Component {
        ...
        showCharts = () => {
            ...
            if (this.state.index == 0 && this.state.contro == 0) {
                l[0].push(this.state.list.json[this.state.list.json.length - 2].CHECKEFFICIENCY, 2);
                l[1].push(this.state.list.json[this.state.list.json.length - 2].CHECKEFFICIENCY, this.state.list.json[this.state.list.json.length - 4].CHECKEFFICIENCY);
                ...
                for (let a in js) {
                    num += Number(js[a].CHECKEFFICIENCY);
                    l[1].push(js[a].CHECKEFFICIENCY);
                ...
                l[0].push(this.state.list.json[this.state.list.json.length - 1].CHECKEFFICIENCY, 2);
                l[1].push(this.state.list.json[this.state.list.json.length - 1].CHECKEFFICIENCY, this.state.list.json[this.state.list.json.length - 3].CHECKEFFICIENCY);
            ...
            publish("cysx/showCharts", l).then((res) => {
