        ...
        tabs: [
            ...
            },
            {
                ...
                data: [
                    ...
                    { num: '0', title: '旅检船舶未审批即移泊', botview: '旅检船舶未确认即移泊', type: "bj", col: 'color :#FE6668', cla: 'WARNING20', img: require("../images/znyj/bj/jtgzbj.svg") },
                    ...
                    { num: '0', title: '退运柜15天内复进境', botview: '退运柜15天内复进境', type: "bj", col: 'color :#FE6668', cla: 'WARNING24', img: require("../images/znyj/bj/jtgzbj.svg") },
                ]
            },
        ],
        onGridItemClick: (e) => {
