      ...
      grids: [
        {
          ...
          items: [
            ...
            {title: '查验时效', color: '#ffb84e', src: require("../images/zntj/tgsj/hgcy.svg"), router: '/zntj_cysx'},            
            ...
            {title: '海关查验情况', color: '#42cb93', src: require("../images/zntj/tgsj/jzxsb.svg"), router: '/zntj_hgcyqk'}
          ]
        },
        {
          name: "码头数据",
          items: [
            ...
            { title: "未申报集装箱", color: "#fecc7f", src: require("../images/zntj/mtsj/wsbjzx.svg"), router: '/zntj_mtwsbjzx' },
